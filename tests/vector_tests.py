...
class TestGuppy(unittest.TestCase):
    ...
    def test_subsection_cartesian(self):
        ...
        self.assertEqual([pt.x for pt in points], [0.0, 0.318619234003536,
            0.637238468007072, 0.9558577020106079, 1.274476936014144,
            1.59309617001768, 1.911715404021216, 2.230334638024752,
            2.5489538720282883, 2.867573106031824, 3.294395938694146,
            3.7981771815888177, 4.0, 4.0, 4.0, 4.0, 4.0, 4.0,
            3.5037812428946715, 3])

        self.assertEqual([pt.y for pt in points], [0.0, 0.637238468007072,
            1.274476936014144, 1.9117154040212159, 1.4510461279717122,
            0.8138076599646402, 0.17656919195756826, -0.4606692760495037,
            -1.0979077440565757, -1.7351462120636478, -1.7056040613058538,
            -1.2018228184111823, -0.5729663008226373, 0.13948796534818164,
            0.8519422315190006, 1.5643964976898195, 2.2768507638606383,
            2.989305030031457, 2.503781242894671, 2])
        return
    ...
    def test_subsection_lonlat(self):
        ...
        self.assertEqual([pt.x for pt in points], [0, 4.006549675732082,
            8.44359845345209, 13.382442375999254, 18.894149336762318,
            25.03918819127435, 31.85052685770255, 39.31083346558522,
            47.329401349484314, 55.7308352362257, 64.26916476377436,
            72.67059865051574, 80.68916653441482, 88.14947314229748,
            94.96081180872568, 101.10585066323772, 106.61755762400078,
            111.55640154654793, 115.99345032426793, 120.00000000000003, 120])
                
        self.assertEqual([pt.y for pt in points], [40, 43.200316625343305,
            46.2434129228378, 49.09308515921458, 51.705248417290484,
            54.027440893063556, 55.99968253476488, 57.55771841446013,
            58.6395037346357, 59.194673757153645, 59.19467375715364,
            58.639503734635674, 57.557718414460105, 55.999682534764844,
            54.02744089306352, 51.705248417290456, 49.09308515921457,
            46.24341292283779, 43.2003166253433, 39.99999999999997, 40])
        return
